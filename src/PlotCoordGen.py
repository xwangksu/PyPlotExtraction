...
ap.add_argument("-t", "--tpath", required=True, help="targetField")
args = vars(ap.parse_args())
tgt = args["tpath"]

originalPoints = pd.read_csv('J:/2020_CIMMYT/RedEdge/shapefiles/'+tgt+'_full_points.csv', header = 0, usecols=[0,1,2])
...
#
# 4     3
fieldmap = pd.read_csv('J:/2020_CIMMYT/RedEdge/full/'+tgt+'_full.csv', header = None)
fieldmap.iloc[0][0]
...
# cpsy
import csv
finalFile = open('J:/2020_CIMMYT/RedEdge/shapefiles/'+tgt+'_full_layout.csv','wt')
try:
