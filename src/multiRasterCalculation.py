...
# Raster layer define
    ...
    # Tiff saving define
    imFileName = str(im)
    redTiff = imFileName.replace("_1.tif","_R.tif")
    greenTiff = imFileName.replace("_1.tif","_G.tif")
    blueTiff = imFileName.replace("_1.tif","_B.tif")
    redEdgeTiff = imFileName.replace("_1.tif","_RE.tif")
    nirTiff = imFileName.replace("_1.tif","_NIR.tif")
    ndviTiff = imFileName.replace("_1.tif","_NDVI.tif")
    ndreTiff = imFileName.replace("_1.tif","_NDRE.tif")
    gNDVITiff = imFileName.replace("_1.tif","_GNDVI.tif")
