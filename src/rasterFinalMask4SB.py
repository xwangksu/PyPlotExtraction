...
n3Im = filePath + '\\' + dateString + '_nHue_mask.tif'
satIm = filePath + '\\' + dateString + '_rnSat_n3mask_mask.tif'
...
satByN3MaskTiff = filePath + '\\' + dateString + '_FinalMask.tif'
